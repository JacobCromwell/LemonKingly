class AudioManager {
    ...
    generateSoundEffects() {
        ...
        // Add this to the generateSoundEffects() method in audioManager.js
        // Insert after the exploder sound generation

        // Generate miner sound (pickaxe hitting rock)
        this.sounds.miner = this.createSound(() => {
            // Create a metallic "chink" sound
            ...
            // Primary tone (metallic ring)
            osc1.type = 'square';
            osc1.frequency.setValueAtTime(800, this.audioContext.currentTime);
            osc1.frequency.exponentialRampToValueAtTime(200, this.audioContext.currentTime + 0.1);

            // Secondary tone (impact)
            osc2.type = 'triangle';
            osc2.frequency.setValueAtTime(150, this.audioContext.currentTime);
            osc2.frequency.exponentialRampToValueAtTime(80, this.audioContext.currentTime + 0.15);

            // Filtered noise for rocky texture
            filter.type = 'bandpass';
